...
namespace Tadawi.Controllers
{
    public class PharmaciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Location,Phone")] Pharmacy pharmacy)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Location,Phone")] Pharmacy pharmacy)
        {
            if (id != pharmacy.Id)
            {
                return NotFound();
